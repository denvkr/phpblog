...
$request->create(filter_input(INPUT_SERVER,'DOCUMENT_ROOT').'/blog','GET');

//if ($request->get('_route')=='blog'){
    //echo 'Админка блога';
    ...
    $loader = new Twig_Loader_Filesystem(filter_input(INPUT_SERVER,'DOCUMENT_ROOT').'/blog');
